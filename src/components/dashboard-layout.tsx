...
const DriverSidebar = ({
  ...
  <>
    ...
    <SidebarContent className="bg-sidebar-background text-sidebar-foreground">
      <SidebarMenu>
        ...
        <SidebarMenuItem>
          <SidebarMenuButton
            asChild
            tooltip={{ children: 'Pay Subscription' }}
            variant="ghost"
            className="hover:bg-sidebar-accent hover:text-sidebar-accent-foreground"
          >
            <Link href="#">
        ...
        <SidebarMenuItem>
          <SidebarMenuButton
            asChild
            tooltip={{ children: 'Payment History' }}
            variant="ghost"
            className="hover:bg-sidebar-accent hover:text-sidebar-accent-foreground"
          >
            <Link href="#">
        ...
        <SidebarMenuItem>
          <SidebarMenuButton
            asChild
            tooltip={{ children: 'Request Support' }}
            variant="ghost"
            className="hover:bg-sidebar-accent hover:text-sidebar-accent-foreground"
          >
            <Link href="#">
    ...
    <SidebarFooter className="bg-sidebar-background text-sidebar-foreground p-2 flex flex-col gap-2">
      <SosDialog />
      <Button
        variant="ghost"
...
export default function DashboardLayout({
  ...
  return (
    <SidebarProvider defaultOpen>
      <Sidebar>
        {isDriverView ? (
          <DriverSidebar pathname={pathname} isMounted={isMounted} />
        ) : (
          <SuperAdminSidebar pathname={pathname} isMounted={isMounted} />
        )}
      </Sidebar>
      <SidebarInset>
