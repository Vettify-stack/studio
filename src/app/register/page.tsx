...
const driverFormSchema = z.object({
  ...
  contactNumber: z.string().regex(/^0\d{9}$/, 'A valid South African contact number is required.'),
...
const companyFormSchema = z.object({
    ...
    phoneNumber: z.string().regex(/^0\d{9}$/, 'A valid South African phone number is required.'),
    registrationNumber: z.string().min(1, 'Company registration number is required.'),
    vatNumber: z.string().optional(),
    physicalAddress: z.string().min(1, 'Physical address is required.'),
    numberOfDrivers: z.coerce.number({required_error: "Number of drivers is required."}).int().positive('Number of drivers must be a positive number.'),
